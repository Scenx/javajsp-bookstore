...
<head>
    ...
    <script type="text/javascript">
        function changeImage() {
            ...
            document.getElementById("img").src = "${pageContext.request.contextPath}/u?method=checkImg&time="
                + new Date().getTime();
        }
    </script>
</head>
...
<div id="divcontent">
    <form action="${pageContext.request.contextPath}/u?method=register"
          method="post">
                    ...
                    <table width="80%" border="0" cellspacing="2" class="upline">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="width:50%"><img
                                    src="${pageContext.request.contextPath}/u?method=checkImg" width="180"
