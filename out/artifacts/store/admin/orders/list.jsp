...
<table cellSpacing="1" cellPadding="0" width="100%" align="center"
    ...
    <form id="Form1" name="Form1" action="${pageContext.request.contextPath}/order?method=findOrderByManyCondition" method="post">
    <tr>
        <td>
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td class="ta_01" bgColor="#ffffff"><input type="text"
                                                                   name="orderid" size="15" value="" id="Form1_userName"
                                                                   class="bg"/>
                        </td>
                        <td height="22" align="center" bgColor="#f5fafe" class="ta_01">
                            收件人：
            ...
            <table cellspacing="0" cellpadding="1" rules="all"
                ...
                <c:forEach items="${orders}" var="o">
                    <tr onmouseover="this.style.backgroundColor = 'white'"
                        ...
                        <td style="CURSOR: hand; HEIGHT: 22px" align="center"
                            width="10%">${o.receiverName}
                        </td>
                        <td style="CURSOR: hand; HEIGHT: 22px" align="center"
                            width="15%">${o.receiverAddress}
                        </td>
                        <td style="CURSOR: hand; HEIGHT: 22px" align="center"
                            width="10%">${o.receiverPhone}
                        </td>
                        <td style="CURSOR: hand; HEIGHT: 22px" align="center">
                                ${o.money}
                        </td>
                        <td width="8%" align="center">${o.user.username}</td>
                        <td width="10%" align="center">${o.paystate==1?"已支付":"未支付"}</td>

                        <td align="center" style="HEIGHT: 22px"><a
                                href="${pageContext.request.contextPath}/order?method=viewOrder&orderid=${o.id}">
                            <img
                                    src="${pageContext.request.contextPath}/admin/images/button_view.gif"
                                    border="0" style="CURSOR: hand"> </a></td>
                        <td align="center" style="HEIGHT: 22px">
                            <a
                                    href="${pageContext.request.contextPath}/order?method=delOrder&orderid=${o.id}">
                                <img
