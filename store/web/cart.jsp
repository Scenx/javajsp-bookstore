...
<head>
    ...
    <script type="text/javascript">
        function changeNum(id, num, totalCount) {
            ...
            location.href = "${pageContext.request.contextPath}/product?method=changeNum&id=" + id + "&num=" + num;
        }
    </script>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <c:forEach items="${cart }" var="entry" varStatus="vs">
                                            <table width="100%" border="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td width="10%"><a
                                                            href="${pageContext.request.contextPath}/product?method=changeNum&id=${entry.key.id}&num=0"
                                        ...
                                        <div style="text-align:right; margin-top:10px">
                                            <a
                                                    href="${pageContext.request.contextPath}/product?method=pagination"><img
                                                    src="images/gwc_jx.gif" border="0"/> </a>

                                            &nbsp;&nbsp;&nbsp;&nbsp;<a
                                                href="${pageContext.request.contextPath}/user/order.jsp"><img
