        ...
        <td>
            <div class="dtree">
                ...
                <script type="text/javascript">
                    ...
                    //子目录添加
                    d.add(11, 1, '商品查看', '${pageContext.request.contextPath}/product?method=findProductByManyCondition', '', 'mainFrame');

                    d.add(12, 1, '销售榜单', '${pageContext.request.contextPath}/admin/products/download.jsp', '', 'mainFrame')

                    d.add(21, 2, '订单查看', '${pageContext.request.contextPath}/order?method=findOrderByManyCondition', '', 'mainFrame');
